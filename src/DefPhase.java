...
public class DefPhase extends MinijavaBaseListener {
    ...
    public void enterFile(MinijavaParser.FileContext ctx) {
        globals = new GlobalScope(null);
        currentScope = globals;
    }
	
    public void exitFile(MinijavaParser.FileContext ctx) {
        System.out.println(globals);
    }

    public void enterFunctionDecl(MinijavaParser.FunctionDeclContext ctx) {
    ...
    public void exitFunctionDecl(MinijavaParser.FunctionDeclContext ctx) {
